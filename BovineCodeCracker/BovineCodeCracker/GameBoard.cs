        ...
        private async void AIsolver()
        {
            if (this.GameOver == false)
            {
                ...
                if (this.thisTurn < 2)
                {
                    ...
                    foreach (string s in Permutations(this.gameControl.CodeLength, this.gameControl.CodeDepth))
                    {
                 ...
                 * FALLBACK
                 * 
                 * At this point, the output list may have eliminated possibilities all the way down to nothing.
                 * So, use the input list instead.
                 * 
                 */
